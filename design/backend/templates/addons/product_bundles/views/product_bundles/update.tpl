...
<div class="content-product-bundle" id="content_group_pb_{$id}">
    <form action="{""|fn_url}" method="post" name="item_update_form_pb" id="item_update_form_pb_{$id}" class="form-horizontal form-edit {if !$allow_save}cm-hide-inputs{/if}" enctype="multipart/form-data">
            ...
            <fieldset>
                ...
                <div id="content_tab_products_{$id}" {if !$allow_save}class="cm-hide-inputs"{/if}>
                    ...
                    {include file="views/products/components/picker/picker.tpl"
                        ...
                        aoc=true
                        additional_query_params="product_type=P&any_variation={'YesNo::YES'|enum}"
                    }
