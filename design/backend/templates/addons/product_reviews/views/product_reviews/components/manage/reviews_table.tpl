...
{foreach $sorting_status_types as $sorting_status_type}
    {if $product_reviews_search.sort_by === $sorting_status_type}
        {include_ext file="common/icon.tpl" class="icon-`$sort_order_rev`" assign=sorting_status_icons_by_type}
    {else}
        {include_ext file="common/icon.tpl" class="icon-dummy" assign=sorting_status_icons_by_type}
    {/if}
    {$sorting_status_icons.$sorting_status_type = $sorting_status_icons_by_type}
{/foreach}
