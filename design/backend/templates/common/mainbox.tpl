...
{hook name="index:actions_wrapper"}
    <div class="actions nav__actions {if $enable_sticky_scroll}cm-sticky-scroll{/if}"
        ...
        <div class="title nav__actions-title pull-left {if $select_storefront}title--storefronts{/if}">
            ...
            <div class="{if isset($main_buttons_meta)}{$main_buttons_meta}{else}btn-bar btn-toolbar{/if} nav__actions-bar dropleft pull-right" {if $content_id}id="tools_{$content_id}_buttons"{/if}>
