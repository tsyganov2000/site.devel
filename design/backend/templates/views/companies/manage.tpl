    ...
    {capture name="companies_table"}
        <div class="table-responsive-wrapper longtap-selection">
            ...
            <tr>
                ...
                {else}
                    <th width="7%"><span class="nowrap cm-tooltip" title="{__("ttc_stores_status")}">{__("stores_status")}&nbsp;{include_ext file="common/icon.tpl" class="icon-question-sign"}{if $search.sort_by === "stores_status"}{$c_icon nofilter}{else}{$c_dummy nofilter}{/if}</span></th>
                {/if}
            </tr>
            </thead>
