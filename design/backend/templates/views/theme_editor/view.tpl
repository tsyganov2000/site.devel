...
<span class="te-nav"><a id="sw_theme_editor_container" class="te-minimize cm-combination" title="{__("theme_editor.hide_show")}">
        {include_ext file="common/icon.tpl"
            class="icon-left-open glyph-left-open"
        }{include_ext file="common/icon.tpl"
            class="icon-right-open glyph-right-open hidden"
        }
    </a>
<a href="{"customization.disable_mode?type=theme_editor"|fn_url}" class="te-close cm-te-close-editor" title="{__("theme_editor.close")}">{include_ext file="common/icon.tpl" class="icon-cancel glyph-cancel"}</a>
        </span>
</span>
...
<div class="theme-editor {if $theme_manifest.converted_to_css} te-converted-to-css{/if}" data-ca-te-use-dynamic-style="{if $runtime.vendor_id}true{else}false{/if}" id="theme_editor_container" data-bp-sidebar="true">
    ...
    <div class="te-header{if !$props_schema} te-header-no-schema{/if}" id="te_styles_list">
        ...
        <span class="te-title">
            ...
            {if !$theme_manifest.converted_to_css && !$runtime.vendor_id}
                <a class="te-action-link cm-te-convert-to-css cm-confirm">
                    <span class="te-action-link-title">{__('theme_editor.convert_to_css')}&nbsp;{include_ext file="common/icon.tpl" class="ty-icon-help-circle cm-tooltip" title=__('theme_editor.text_convert_to_css')}</span>
                </a>
            {/if}
            {/hook}
        </span>
        ...
        {if !$theme_manifest.converted_to_css}
            ...
            <div class="te-header-menu-wrap">
                <div class="te-header-menu-wrap-left">
                    ...
                    <div class="te-select-box cm-te-selectbox te-theme" tabindex="0"><span class="cm-style-title">{$current_style_name|default:__("none")}</span>{include_ext file="common/icon.tpl" class="ty-icon-d-arrow"}
                        ...
                        {foreach from=$styles_list item="s_item"}
                            <li class="{if $runtime.layout.style_id === $s_item.style_id}active{/if}">
                                ...
                                {if $s_item.is_removable|default:true}
                                    <a class="ty-icon-wrap-remove cm-ajax cm-confirm" data-ca-target-id="te_styles_list" href="{"theme_editor.delete_style?style_id=`$s_item.style_id`"|fn_url}">{include_ext file="common/icon.tpl" class="ty-icon-trashcan" title=__("delete")}</a>
                                {/if}
                            </li>
                        {foreachelse}
                            <li class="active">
            ...
            {if $te_sections}
                ...
                <div class="te-select-box cm-te-selectbox te-customize" tabindex="0">
                    <span>{__($te_sections.$selected_section)}</span>{include_ext file="common/icon.tpl" class="ty-icon-d-arrow"}
        ...
        {else}
            ...
            <div class="te-header-menu-wrap">
                <div class="te-header-menu-wrap-left">
                    <div class="te-select-box cm-te-selectbox te-theme" tabindex="0"><span class="cm-style-title">{$selected_css_file|default:__("none")}</span>{include_ext file="common/icon.tpl" class="ty-icon-d-arrow"}
    ...
    <div class="te-wrap te-fonts cm-te-section {if $selected_section != "te_fonts"}hidden{/if}" id="te_fonts">
        <div class="te-inner-wrap">
            ...
            <div class="ty-control-group control-group te-font-group">
                <label for="elm_te_{$name}">{__($field.description)}</label>
                <div class="te-select-box cm-te-selectbox cm-te-google cm-te-value-changer" tabindex="0" data-ca-select-box-default="{$current_style.data.$name}"><span></span>{include_ext file="common/icon.tpl" class="ty-icon-d-arrow"}
                ...
                {if $field.properties.size}
                    ...
                    <div class="te-select-box te-font-size cm-te-selectbox cm-te-value-changer" tabindex="0"><span>{$current_value}</span>{include_ext file="common/icon.tpl" class="ty-icon-d-arrow"}
                ...
                <div>
                    ...
                    {if $field.properties.pattern}
                        <div class="te-bg-pattern-group clearfix">
                            ...
                            <div id="elm_preview_{$name}" class="te-pattern-preview {if !$current_style.parsed} te-pattern-empty{/if} input-prepend cm-te-pattern-selector" data-ca-pattern-dialog="backgrounds_adv_pattern_selector_{$name}">
                                ...
                                {else}
                                    {include_ext file="common/icon.tpl" class="ty-icon-image"}
                                {/if}
                            </div>
                    ...
                    <div id="backgrounds_adv_pattern_{$name}" class="te-bg-advanced hidden">
                        ...
                        <div>
                            ...
                            <div class="te-select-box cm-te-selectbox cm-te-value-changer" tabindex="0"><span>{$repeat_title|default:__("theme_editor.repeat")}</span>{include_ext file="common/icon.tpl" class="ty-icon-d-arrow"}
                        ...
                        <div>
                            ...
                            <div class="te-select-box cm-te-selectbox cm-te-value-changer" tabindex="0"><span>{$scroll_title|default:__("theme_editor.scroll")}</span>{include_ext file="common/icon.tpl" class="ty-icon-d-arrow"}
