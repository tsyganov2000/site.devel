    ...
    <div id="shippings_content">
        {capture name="shippings_table"}
            <div class="table-responsive-wrapper longtap-selection">
                ...
                >
                <tr>
                    <th width="0" class="mobile-hide table__check-items-column{if !$has_available_methods} table__check-items-column--disabled{/if}">
                ...
                >
                    ...
                    <td width="0" class="mobile-hide table__check-items-cell">
