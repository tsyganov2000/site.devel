    ...
    {hook name="shippings:available_for_new_vendors"}
        <div class="control-group">
            ...
            <div class="controls">
                ...
                <input type="checkbox" name="shipping_data[available_for_new_vendors]" id="available_for_new_vendors" {if $shipping.available_for_new_vendors === "YesNo::YES"|enum}checked="checked"{/if} value={"YesNo::YES"|enum} />
            </div>
        </div>
    {/hook}
{/if}
