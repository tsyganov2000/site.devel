<div class="modal signin-modal">
    <form action="{""|fn_url}" method="post" name="main_login_form" class="signin-modal__form cm-skip-check-items">
        ...
        <div class="modal-body">
            ...
            <input class="signin-modal__form-field" type="password" id="password1" name="user_data[password1]" class="input-text cm-autocomplete-off" size="20" maxlength="32" value="            ">

            <label for="password2" class="signin-modal__form-label cm-required">{__("confirm_password")}:</label>
            <input class="signin-modal__form-field" type="password" id="password2" name="user_data[password2]" class="input-text cm-autocomplete-off" size="20" maxlength="32" value="            ">
        </div>
