...
<div id="block_properties_{$html_id}">
    ...
    {/if}
    <input type="hidden" name="result_ids" value="{if $smarty.request.r_result_ids}{$smarty.request.r_result_ids},{/if}block_properties_{$html_id},block_selection" class="cm-no-hide-input"/>
