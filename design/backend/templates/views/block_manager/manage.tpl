...
{capture name="sidebar"}
    ...
    <div class="sidebar-row layouts">
        ...
        <div class="sidebar-field text-right">
            <a class="cm-dialog-opener right" href="{"block_manager.update_location?location=`$location.location_id`&s_layout=`$location.layout_id`"|fn_url}" title="{$location.name}">{__("layout_meta_data")}</a>
        </div>
    </div>
    <hr>
    {/hook}
