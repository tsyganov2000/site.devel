...
<div class="ty-rma-search__toggle cm-combination cm-save-state cm-ss-reverse" id="sw_s_show_options">
    <span class="ty-rma-search__toggle-title">{__("search_by_order")}{include_ext file="common/icon.tpl" class="ty-icon-down-open ty-rma-search__toggle-icon" id="on_s_show_options"}{include_ext file="common/icon.tpl" class="ty-icon-up-open ty-rma-search__toggle-icon hidden" id="off_s_show_options"}</span>
</div>

<div id="s_show_options"{if !($smarty.request.order_status || $smarty.request.order_id)} class="rma-options ty-orders-search-options hidden"{/if}>
    <div class="ty-control-group">
    ...
    <div class="ty-control-group">
        ...
        <div class="ty-rma-search__status">
            {include file="common/status.tpl" status=$smarty.request.order_status display="checkboxes" name="order_status" checkboxes_meta="ty-orders-search__options-status"}
        </div>
    </div>
</div>
