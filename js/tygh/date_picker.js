...
(function (_, $) {
  ...
  var methods = {
    ...
    updateInputs: function updateInputs($el, selected_from, selected_to) {
      ...
      var selected_from_formated = createMoment(selected_from).format($el.data('caDateFormat'));
      var selected_to_formated = createMoment(selected_to).format($el.data('caDateFormat'));
