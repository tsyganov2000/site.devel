...
Ожидаемый результат: Все странницы открываются без ошибок, создание тестового отдела проходит без ошибок, после нажатия нажатия кнопки "Создать" происходит на переход на странницу с редактированием данного отдела.
